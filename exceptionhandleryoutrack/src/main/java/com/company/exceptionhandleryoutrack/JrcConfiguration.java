...
@PropertySource(name = "com.company.exceptionhandleryoutrack", value = "classpath:/com/company/exceptionhandleryoutrack/module.properties")
public class JrcConfiguration {

    @Bean("jrc_JrcViewControllers")
    public ViewControllersConfiguration screens(final ApplicationContext applicationContext,
        ...
        viewControllers.setBasePackages(Collections.singletonList("com.company.exceptionhandleryoutrack"));
    ...
    public ActionsConfiguration actions(final ApplicationContext applicationContext,
        ...
        actions.setBasePackages(Collections.singletonList("com.company.exceptionhandleryoutrack"));
        return actions;
    }
}
